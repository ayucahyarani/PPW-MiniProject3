  ...
  <div class="container" style="margin-top:50px;">
    <div id="content-news" class="row">
      <div class="col-12 col-md-8">
        ...
        ?>
          <div class="card border-0 w-100" data-aos="fade-up" data-aos-duration="1000" style="box-shadow: none;">
        ...
        $pagLink = "<ul class='pagination mt-5'>";
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <br>
                <!-- Tambahkan kelas 'animate__animated' dan 'animate__fadeInUp' untuk animasi fade in saat muncul -->
                <a href="../beritapage.php?id_berita=<?= $data['id_berita'] ?>" class="multi-line-truncate mb-0 mt-2 animate__animated animate__fadeInUp"><?= $data['judul_berita'] ?></a>
              </td>
            </tr>
          <?php
          } ?>
